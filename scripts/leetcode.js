...
LeetCodeV2.prototype.insertToAnchorElement = function (elem) {
  ...
  let target = document.querySelector('[data-e2e-locator="console-submit-button"]').parentElement
    .parentElement.parentElement.parentElement.parentElement.parentElement.childNodes;
  if (checkElem(target)) {
    elem.className = 'runcode-wrapper__8rXm';
